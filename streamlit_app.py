        ...
        for (yy, mm), edited in edited_by_month.items():
            ...
            for r in edited:
                ...
                if not isinstance(d, date):
                    continue
                sh_raw = r.get("Fascia", "")
                # normalize_fascia returns a (canonical_value, changed, unknown) tuple.
                # Do NOT call string methods on it (e.g. ".strip()"), otherwise you
                # will get: AttributeError: 'tuple' object has no attribute 'strip'.
